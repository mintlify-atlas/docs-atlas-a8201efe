...
<Card title="View Compiled PDF" icon="file-pdf" href="https://github.com/Mirza42069/CV_Template/raw/main/examples/cv_id.pdf">
...
<CardGroup cols={2}>
  <Card title="English CV" icon="flag-usa" href="/examples/english-cv">
    View the English CV example
  </Card>
  <Card title="Template Customization" icon="palette" href="/guide/styling">
